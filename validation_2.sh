...
python train_2.py --arch denseunet --log_dir ./log/cv --fold 1 --save ./work/cv/pyramid_fold_1 --gpu 2
python train_2.py --arch denseunet --log_dir ./log/cv --fold 2 --save ./work/cv/pyramid_fold_2 --gpu 2
python train_2.py --arch denseunet --log_dir ./log/cv --fold 3 --save ./work/cv/pyramid_fold_3 --gpu 2
python train_2.py --arch denseunet --log_dir ./log/cv --fold 4 --save ./work/cv/pyramid_fold_4 --gpu 2
python train_2.py --arch denseunet --log_dir ./log/cv --fold 5 --save ./work/cv/pyramid_fold_5 --gpu 2
